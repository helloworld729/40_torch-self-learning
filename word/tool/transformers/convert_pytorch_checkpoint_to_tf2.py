...
from tool.transformers import is_torch_available, cached_path

from tool.transformers import (load_pytorch_checkpoint_in_tf2_model,
...
if is_torch_available():
    import torch
    import numpy as np
    from tool.transformers import (BertForPreTraining, BertForQuestionAnswering, BertForSequenceClassification, BERT_PRETRAINED_MODEL_ARCHIVE_MAP,
