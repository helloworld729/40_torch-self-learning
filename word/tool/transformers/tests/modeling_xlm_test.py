...
if is_torch_available():
    from tool.transformers import (XLMConfig, XLMModel, XLMWithLMHeadModel, XLMForQuestionAnswering,
                                   XLMForSequenceClassification, XLMForQuestionAnsweringSimple)
    from tool.transformers import XLM_PRETRAINED_MODEL_ARCHIVE_MAP
else:
