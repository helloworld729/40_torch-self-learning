...
if is_torch_available():
    import torch
    from tool.transformers import (TransfoXLConfig, TransfoXLModel, TransfoXLLMHeadModel)
    from tool.transformers import TRANSFO_XL_PRETRAINED_MODEL_ARCHIVE_MAP
else:
