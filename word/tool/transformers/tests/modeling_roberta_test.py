...
if is_torch_available():
    import torch
    from tool.transformers import (RobertaConfig, RobertaModel, RobertaForMaskedLM, RobertaForSequenceClassification)
    from tool.transformers import ROBERTA_PRETRAINED_MODEL_ARCHIVE_MAP
else:
