...
trainset = torchvision.datasets.MNIST('MNIST_data', train=True, download=False, transform=transform)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=128, shuffle=True)

testset = torchvision.datasets.MNIST('MNIST_data', train=False, download=False, transform=transform)
