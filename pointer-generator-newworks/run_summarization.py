...
# Pointer-generator or emotionBaseline model
tf.app.flags.DEFINE_boolean('pointer_gen', True, 'If True, use pointer-generator model. If False, use emotionBaseline model.')
