...
def outputids2words(id_list, vocab, article_oovs):
  ...
  Args:
    ...
    vocab: Vocabulary object
    article_oovs: list of OOV words (strings) in the order corresponding to their temporary article OOV ids (that have been assigned in pointer-generator mode), or None (in emotionBaseline mode)
  ...
  for i in id_list:
    try:
      ...
      assert article_oovs is not None, "Error: model produced a word ID that isn't in the vocabulary. This should not happen in emotionBaseline (no pointer-generator) mode"
...
def show_abs_oovs(abstract, vocab, article_oovs):
  ...
  Args:
    abstract: string
    vocab: Vocabulary object
    article_oovs: list of words (strings), or None (in emotionBaseline mode)
  """
  unk_token = vocab.word2id(UNKNOWN_TOKEN)
  ...
  for w in words:
    if vocab.word2id(w) == unk_token: # w is oov
      if article_oovs is None: # emotionBaseline mode
