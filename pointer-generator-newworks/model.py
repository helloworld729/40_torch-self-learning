...
class SummarizationModel(object):
  """A class to represent a sequence-to-sequence model for text summarization. Supports both emotionBaseline mode, pointer-generator mode, and coverage"""
  ...
  def _add_seq2seq(self):
    ...
    if hps.mode == "decode":
      ...
      topk_probs, self._topk_ids = tf.nn.top_k(final_dists, hps.batch_size*2) # take the k largest probs. z_note batch_size=beam_size in decode mode
  ...
  def decode_onestep(self, sess, batch, latest_tokens, enc_states, dec_init_states, prev_coverage):
    ...
    Returns:
      ...
      p_gens: Generation probabilities for this step. A list length beam_size. List of None if in emotionBaseline mode.
